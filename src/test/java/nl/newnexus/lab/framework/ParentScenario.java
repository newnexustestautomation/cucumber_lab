...
public class ParentScenario extends GalenTestNgTestBase
{

    protected static Logger log = LogManager.getLogger(ParentScenario.class);
    ...
    public static void setBrowserType(String browserType) {
        ParentScenario.browserType = browserType;
    }
